...
function deleteingred(event) {
	...
	/*
	 * var xhr = new XMLHttpRequest(); xhr.open("POST", "gestionP", true);
	 * xhr.setRequestHeader("Content-Type",
	 * "application/x-www-form-urlencoded");
	 * 
	 * var Produit = new Object(); var ParametresProduit = new Object(); var
	 ...
	 * 
	 * if(menu.value != "-1"){ ParamList.valeurParam = "0"; } else{
	 * ParamList.valeurParam = "1"; }
	 * 
	 * 
	 * console.log(Produit); console.log(ParamList);
	 * 
	 * 
	 * 
	 ...
	 * xhr.status == 200) { var jsonString = xhr.responseText;
	 * console.log(jsonString); var objectUtilisateur = JSON.parse(jsonString);
	 * console.log("test" + objectUtilisateur.userName);
	 * console.log(objectUtilisateur.password); console.dir(jsonString);
	 * 
	 * 
	 * 
	 * 
...
if(test!=-3){
	...
	xhr.onreadystatechange = function() {
		if (xhr.readyState == 4 && xhr.status == 200) {
			...
			// console.log("test" + objectIngredient);
			
			
			
		/*
		 * var li = document.createElement("li"); var btn =
		 * document.createElement("button"); var select =
		 * docment.createElement("select"); var option =
		 * document.createElement("option"); var label =
		 * document.createElement("label"); var input =
