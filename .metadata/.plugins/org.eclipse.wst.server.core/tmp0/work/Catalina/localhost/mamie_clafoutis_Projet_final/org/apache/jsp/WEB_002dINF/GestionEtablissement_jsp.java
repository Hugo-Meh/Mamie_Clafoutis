 ...
 * Generated at: 2017-12-08 17:12:07 UTC
...
public final class GestionEtablissement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("entities.Role");
    _jspx_imports_classes.add("entities.Etablissement");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Gestion Etablissement</title>\r\n");
      out.write("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\r\n");
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"  css/styles.css\">\r\n");
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"style/styleHeaderMenu.css\">\r\n");
      out.write("<link rel=\"stylesheet\" type=\"text/css\" href=\"style/MamieClafoutis.css\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
...
if(idEtab!=2) {
      ...
      out.write("\t<img class=\"img-banner\" alt=\"\" src=\"images/gestion-etablissement-banner.jpeg\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<h1 class=\"titre\">Gestion Etablissement</h1>\r\n");
      out.write("\t<!-- affichage gestion etablissement administration -->\r\n");
      out.write("\t");
 if ((user != null) && (user.getRole().getId()==1)) { 
      out.write("\r\n");
      out.write("\t<div class=\"container \">\r\n");
      out.write("\t\t<!-- =========================== PRODUITS PID #1========================   -->\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<button class=\"bouton btn-submit\" id=\"btn-gestion-etablissement\">\r\n");
      out.write("\t\t\t<a href=\"gestionEtablissement?action=urlAddEtab\">Ajouter Etablissement</a>\r\n");
      out.write("\t\t</button>\r\n");
      out.write("\t\t<form action=\"Produits.jsp\" method=\"post\">\r\n");
      out.write("\t\t\t<table class=\"table table-bordered \">\r\n");
      out.write("\t\t\t\t<thead class=\"  bg-info\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<!-- ROW #1 -->\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<th>NOM ETABLISSEMENT</th>\r\n");
      out.write("\t\t\t\t\t\t<th>ADRESSE</th>\r\n");
      out.write("\t\t\t\t\t\t<th>CODE POSTAL</th>\r\n");
      out.write("\t\t\t\t\t\t<th>TELEPHONE</th>\r\n");
      out.write("\t\t\t\t\t\t<th>TYPE ETABLISSEMENT</th>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</thead>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<tbody>\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<!--#1 TABLE ROW -->\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(etablissements.getName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t");
 if (etablissements.getAdresse() !=null){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(etablissements.getAdresse().getNumero_rue()+" " );
      out.print( etablissements.getAdresse().getNom_rue()+" " );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(etablissements.getAdresse().getVille()+" " );
      out.print(etablissements.getAdresse().getPays() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(etablissements.getAdresse().getCode_postal() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(etablissements.getTel() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t");
 if(etablissements.getTypeEtablissement() != null) {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(etablissements.getTypeEtablissement().getType() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t");
} 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- affichage gestion etablissement pour gerent et chefboulanger -->\r\n");
      out.write("\t");

	if ((user != null) && (user.getRole().getId()==2) && (user.getEtablissement().getId()==2) )  {
	
      out.write("\r\n");
      out.write("\t<div id=\"infoGestionEtablissement\">\r\n");
      out.write("\t\t<ul>\r\n");
      out.write("\t\t\t<li><label  class=\"label-form\">Nom etablissement</label>");
      out.print(monEtablissement.getName() );
      out.write("</li>\r\n");
      out.write("\t\t\t<li><label  class=\"label-form\">Adresse</label>");
      out.print(monEtablissement.getAdresse().getNumero_rue()+" " );
      out.print(monEtablissement.getAdresse().getNom_rue()+", " );
      out.write("\r\n");
      out.write("\t\t\t");
      out.print(monEtablissement.getAdresse().getVille()+", " );
      out.print(monEtablissement.getAdresse().getPays() );
      out.write("</li>\r\n");
      out.write("\t\t\t<li><label  class=\"label-form\">Code Postal</label>");
      out.print(monEtablissement.getAdresse().getCode_postal() );
      out.write("</li>\r\n");
      out.write("\t\t\t<li><label  class=\"label-form\">Telephone</label>");
      out.print(monEtablissement.getTel() );
      out.write("\r\n");
      out.write("\t\t\t<li><label  class=\"label-form\">Type etablissement</label>");
      out.print(monEtablissement.getTypeEtablissement().getType() );
      out.write("\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<button class=\"bouton btn-submit\" >Modifier</button>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t");
} 
