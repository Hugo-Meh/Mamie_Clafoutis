...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% ArrayList<Produit> produitsPanier = (ArrayList<Produit>) SessionManager.getSessionTabValue(C.Produit.tabProduitListPanier, request );  %>
...
<div class="container tableau_de_produits">
							...
							<td class="quantite_th_td">
								<div class="  text-center">
									...
									<div style="padding-top: 10px">
										<input id="input_quantite" type="text" class="form-control qteprod"
											maxlength="3" size="3" placeholder="QTY "
											name="input_quantite " value="<%=p.getQuantite()%>"></label>
		...
		<button class="bouton btn-submit" id="validationCommande">Valider Commande</button>
	</div>
